...
export default function IndomaretTable({ rows, cabangList, filters, onFiltersChange, idasDate, dataType = 'indomaret', isLocked = false, onRefetch }) {
  ...
  const handleExportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'Indomaret')
    XLSX.writeFile(wb, `Indomaret_${idasDate || 'data'}.xlsx`)
  }
  ...
  const handleExportPDF = () => {
    ...
    exportTableToPDF({
      title: 'INDOMARET MONITORING',
      subtitle: `IDAS Date: ${idasDate || '-'}`,
      headers,
      data,
      fileName: `Indomaret_${idasDate || 'data'}.pdf`,
