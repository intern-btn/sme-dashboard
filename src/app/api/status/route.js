...
export async function GET() {
  try {
    ...
    const [npl, kol2, realisasi, realisasi_kredit, posisi_kredit, prk_spbu, bpjs, indomaret, productivity] = await Promise.all([
    ...
    return NextResponse.json({ npl, kol2, realisasi, realisasi_kredit, posisi_kredit, prk_spbu, bpjs, indomaret, productivity })
  } catch (error) {
